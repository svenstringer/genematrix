...
>publish_default_genematrix()

The first run may take up to an hour, to 
# Creating a custom gene-matrix in steps

Although the publish_default_genematrix

## Core gene matrix

All third-party annotation will be merged into the core gene matrix. The creation of this core gene matrix involves several steps.
