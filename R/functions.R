...
add_annotations <- function(core, gene_translation_table, annotations, value_sep) {
    gene_matrix <- core

    # Add pli scores from exac
    gene_matrix <- merge_exacpli(fullexacpli_url, gene_matrix, gene_translation_table, gene_start_bp_dif = 5e+05)
    gene_matrix <- merge_exacpli(nonpsychexacpli_url, gene_matrix, gene_translation_table, gene_start_bp_dif = 5e+05)
